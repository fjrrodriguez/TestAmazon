...
public class Prueba {
    ...
    //Objeto de la clase EjecutarGoogle;
    EjecutarGoogle google = new EjecutarGoogle();
    ...
    public void el_usuario_navega_en_la_pagina_de_amazon()  {
        //Se ejecuta el drive que nos lleva a amazon desde el navegador Google Chrome
    google.abrirGoogle();
    ...
    public void busca_el_articulo_Alexa()  {
        ...
        WebElement barrabusqueda = google.driver.findElement(By.name("field-keywords"));
        ...
        WebElement botonbuscar = google.driver.findElement(By.id("nav-search-submit-button"));
    ...
    WebElement pagdos = google.driver.findElement(By.linkText("2"));
    ...
    public void selecciona_el_tercer_item_de_los_resultados() throws InterruptedException {
        ...
        WebDriverWait espera = new WebDriverWait(google.driver, 3); // Establece un tiempo de espera máximo de 3 segundos
    ...
    public void agrega_al_carrito_mas_de_dos_unidades_del_tercer_item_si_esta_disponible_para_compra() throws InterruptedException {
        ...
        WebDriverWait esperar = new WebDriverWait(google.driver, 3); // Establece un tiempo de espera máximo de 3 segundos
        ...
        if(cant.isDisplayed()){
            ...
            WebElement elementoDeseado = google.driver.findElement(By.xpath("(//li[@class='a-dropdown-item'])[2]"));
        ...
        WebElement carrito = google.driver.findElement(By.xpath("(//div[@class='a-button-stack'])[1]"));
        //Se da clic sobre el boton
        carrito.click();
        }
    }
